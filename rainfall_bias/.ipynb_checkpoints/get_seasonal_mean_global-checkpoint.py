...
# GAL_mask = GAL1h.sel(time=slice("2020-01-01", "2021-12-31"))
RAL_mask = RAL1h.sel(time=slice("2020-01-01", "2021-12-31"))
COMA1_mask = COMA1_1h.sel(time=slice("2020-01-01", "2021-12-31"))
COMA2_mask = COMA2_1h.sel(time=slice("2020-01-01", "2021-12-31"))
# IMERG_mask = ds_imerg.sel(time=slice("2020-01-01", "2021-12-31"))
